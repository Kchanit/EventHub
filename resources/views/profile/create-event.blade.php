...
@section('content')
    ...
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:pt-1 pb-14 mx-auto">
        <form id="myForm" name="myForm" action="{{ route('profile.store-event') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Card -->
