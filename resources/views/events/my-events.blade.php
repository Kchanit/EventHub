...
@section('content')
    ...
    <div>
        <div class="flex items-center justify-between">
            ...
            <button
                class="py-2.5 px-6 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-800 rounded-3xl inline-flex gap-x-2 content-center shadow-md duration-300 hover:-translate-y-1 hover:bg-gray-800 hover:text-white dark:hover:bg-white dark:hover:text-gray-700">
                Create Event
            </button>
                    ...
                    <div class=" rounded-xl shadow-lg shadow-gray-200 dark:shadow-gray-900 bg-white dark:bg-gray-800 duration-150 hover:-translate-y-1"
                        ...
                        <a _href="link" class="cursor-pointer ">
                            <figure class="group relative">
                                <span
                                    class="z-10 opacity-0 transition duration-300 group-hover:opacity-100 group-hover:ease-in-out absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pr-6 pl-6 pt-4 pb-4 text-center text-black bg-opacity-90 bg-white  dark:text-white dark:bg-opacity-95  dark:bg-gray-800  rounded-3xl">
                                    Manage Event
                                </span>
