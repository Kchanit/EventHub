            ...
            <div
                ...
                <button type="button">
                    <a href="{{ route('profile.create-event') }}"
                        class="flex items-center justify-center px-4 py-2 text-sm font-medium text-black rounded-lg bg-white border border-gray-200 shadow-md md:w-auto focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 ">
                ...
                <div class="flex items-center w-full space-x-3 md:w-auto">
                    <div x-data="{ isOpen: false }">
                        <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown" @click="isOpen=!isOpen"
                            ...
                            class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-900 shadow-md bg-white border border-gray-200 rounded-lg md:w-auto focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 "
                            type="button">
                    ...
                    <div x-data="{ isOpen: false }">
                        <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown" @click="isOpen=!isOpen"
                            @click.away="isOpen=false"
                            class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium shadow-md text-gray-900 bg-white border border-gray-200 rounded-lg md:w-auto focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 "
                            type="button">
                        ...
                        <div x-show="isOpen" id="filterDropdown"
                            class="z-10 w-48 p-3 right-0 absolute mt-1 bg-white rounded-lg shadow ">
