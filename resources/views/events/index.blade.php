...
<div>
    ...
    <div class="max-w-[64rem] sm:px-6 lg:px-1 lg:py-12 mx-auto">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Card -->
            <div class=" rounded-3xl overflow-hidden shadow-lg h-[28rem] shadow-gray-300 dark:shadow-gray-900 bg-white dark:bg-gray-800 duration-150 hover:-translate-y-1">
                <!-- Clickable Area -->
            ...
            <div class=" rounded-3xl overflow-hidden shadow-lg h-[28rem] shadow-gray-300 dark:shadow-gray-900 bg-white dark:bg-gray-800 duration-150 hover:-translate-y-1">
                ...
                <a href="{{ route('events.show') }}" class="cursor-pointer">
                    <figure class="group relative">
                        <!-- Image -->
                        <img class="bg-gray-300 h-full w-full object-cover z-0" src="https://p-u.popcdn.net/event_details/posters/000/015/695/large/2f4b41db65c10947730f2a64eb916bfd4b6230a8.png?1689753720" />
                        <div class="px-4 py-2">
                            <!-- Date -->
                            <span class="block text-xs font-semibold uppercase text-blue-600 dark:text-blue-500">
                                7-8 October 2023
