                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    ...
                                    <td class="h-px w-px whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-2">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Beverage
                                                    Booth</span>
                                            </div>
                                        </a>
                                    </td>
                                    ...
                                    <td class="h-px w-px whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-2">
                                                <span class="block text-sm text-gray-800 dark:text-gray-200">build mini
                                                    booth and require 2 members</span>
                                            </div>
                                        </a>
                                    </td>
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    <td class="h-px w-px whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-2">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">MC
                                                    work</span>
                                            </div>
                                        </a>
                                    </td>
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    ...
                                    <td class="h-px w-px whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-2">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Permissions</span>
                                            </div>
                                        </a>
                                    </td>
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    <td class="h-px w-px whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-2">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Overall
                                                    schedule</span>
                                            </div>
                                        </a>
                                    </td>
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-3">
                                                <span class="block text-sm text-gray-500">draft and finalize overall
                                                    schedule</span>
                                            </div>
                                        </a>
                                    </td>
                                ...
                                <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    <td class="h-px w-px whitespace-nowrap">
                                        <a class="block" href="javascript:;" data-hs-overlay="#hs-ai-invoice-modal">
                                            <div class="px-6 py-2">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Buy
                                                    materials</span>
                                            </div>
                                        </a>
                                    </td>
