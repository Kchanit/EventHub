<footer class="mt-auto w-full max-w-[85rem] py-4 px-4 sm:px-6 lg:pl-72 lg:pr-8 mx-auto bg-white ">
    <!-- Grid -->
    <div class="text-center">
        <div>
            <a class="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Brand">EventHub</a>
        </div>
        <!-- End Col -->

        <div class="mt-3">
            <p class="text-gray-500">© EventHub. 2023. All rights reserved.</p>
        </div>
