         ...
         <div class="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
             ...
             <div class="flex flex-row items-center justify-end gap-2">
                 ...
                 <div x-data="{ isOpen: false }">
                     ...
                     <div x-show="isOpen"
                         class=" overflow-hidden absolute right-0 z-50 my-4 max-w-sm text-base list-none bg-green divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
