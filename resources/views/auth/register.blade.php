            ...
            <div class="mt-5">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password"
                        class="block mt-1 w-full text-sm font-medium text-gray-800  dark:text-gray-200" type="password"
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="student_id"
                        ...
                        name="student_id" :value="old('student_id')" required autofocus autocomplete="student_id" />
