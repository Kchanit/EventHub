  ...
  <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
    ...
    <div>
      ...
      <blockquote class="relative">
        ...
        Your <span class="text-blue-600 dark:text-blue-500">Profile</span>
      </h1>
        </div>
        ...
        <footer class="mt-6">
          <div class="flex items-center">
            ...
            <p class="text-3xl font-medium bold text-gray-800 md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal dark:text-gray-200">
            Nicole Grazioso
          </p>
          </div>
        </footer>
        ...
        <div class="mt-8 lg:mt-14">
          <a class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-gray-800 text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm lg:p-4 dark:focus-visible:ring-offset-gray-800" href="/info/editInfo">
            Edit Profile
          </a>
        </div>
      </blockquote>
